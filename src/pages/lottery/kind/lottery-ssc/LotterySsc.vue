<template>
  <view-page ref="view-page" full-box :position-style="positionStyle">
    ...
    <section slot="content" class="lotter-ssc">
      <van-tabs v-model="playWayIndex" animated swipeable :line-width='0' :line-height="0" class="lottery-body no-tab theme-header-bg">
