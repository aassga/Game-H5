          ...
          <div v-show="showMoreModal">
            <ul class="more-list">
              <li class="row theme-main-bg-5">
                ...
                <span class="col col-info theme-border-color theme-color-white">跨度</span>
                <span class="col col-info theme-border-color theme-color-white">走势</span>
              </li>
              <li :class="['row',i % 2 === 0 ? 'theme-header-bg' : 'theme-main-bg-5']" v-for="(item,i) in results" :key="item.issue + '_' + i">
                <span class="col col-issue theme-border-color theme-color-white">{{item['issue'].toString().substr(-3)}}</span>
                ...
                <span class="col col-info">{{item['kd']}}</span>
                <span class="col col-info">{{item['xt']}}</span>
              </li>
            </ul>
