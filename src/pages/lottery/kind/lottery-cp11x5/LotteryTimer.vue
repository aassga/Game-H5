...
export default {
  ...
  computed: {
    digStyle(){
      return `background-image:url(${require(`../../../../assets/img/digitRoll/jiangchi_${localStorage.theme ? localStorage.theme : (this.$config.home === 'vns' ? 'bluegreen': this.$config.home === 'amhg'?'yellow' : 'default') }.png`)})`
    },
    timeStr () {
