<template>
  <view-page header-touch full-box :noScroll="true" ref="viewPage">
    <title-header
      slot="header"
      class="header-top"
      v-no-touch-move
    ...
    >
      <div :class="[{FocusSearch:isFocusSearch},'top-bar1']">
        <img src="@src/assets/img/game/back-icon.png" class="h-back" @click="$router.push('/')"/>
        <div class="search-box clearfix">
            <img src="@src/assets/img/game/search-icon.png" class="search-icon"/>
      ...
      <div :class="[{FocusSearch:isFocusSearch},'top-bar2']" @click="changeIsFocus(true)">
        <img src="@src/assets/img/game/back-icon.png" class="h-back" @click.stop="changeIsFocus(false)"/>
        <div class="search-box clearfix">
            <img src="@src/assets/img/game/search-icon.png" class="search-icon"/>
            <van-search
            ref="vanSearch"
        ...
        <img
          src="@src/assets/img/game/clear-icon.png"
          class="clear-icon"
    ...
    <div class="content newSolt" slot="content" ref="content">
      <div v-show="!isFocusSearch">
        ...
        >
        <div class="fl left-box" style="background:#000">
            <div class="left-nav" ref="leftNav" v-if="leftListArr.length > 0">
                ...
                <div
                    slot-scope="props"
                    :class="[current === props.index ? 'theme-agent-tab-active' : '' ,'borderRadius']"
              ...
              <div class="right-game-scroll">
                ...
                <div class="animation-box" ref="animationBox" v-if="isShow">
                  ...
                  <div v-if="!showGameList || showGameList.length < 1" class="list-empty">
                    <img class="no-data" src="@src/assets/img/game/new-game/no-data.png" />
                    <p class="info">暂无游戏</p>
                  </div>
                </div>
              </div>
...
.header-top {
  ...
  height: 0.88rem;
  background-color:#C62721 !important;
  .h-back{
    position: absolute;
    top:0.2rem;
    left:0.25rem;
