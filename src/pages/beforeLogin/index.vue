...
export default {
  ...
  created() {
    if(this.$route.query.token) {
      localStorage.token = decodeURIComponent(escape(window.atob(this.$route.query.token)))
      this.$store.state.user.token = decodeURIComponent(escape(window.atob(this.$route.query.token)))
      this.$nextTick(() => {
