<template>
  <view-page class="login-box theme-header-bg" :full-box="!isShowFixed" ref="view-page">
    <div slot="content">
      <div class="content" v-show="!showStep">
        <a class="back-icon" href="javascript:;" @click="goBack()">
        </a>
        <div class="head">
          <img :src="require('../../assets/img/login/kyqp/' + $config.name +'-login-bg.png')" v-if="tabIndex === 0" class="img-bg">
          <img :src="require('../../assets/img/login/kyqp/' + $config.name +'-reg-bg.png')" v-if="tabIndex === 1" class="img-bg">
        ...
        <div class="btn-group">
          <img src="../../assets/img/login/kyqp/no_l.png" v-if="tabIndex === 1" @click="goLogin">
          <img src="../../assets/img/login/kyqp/active_l.png" v-if="tabIndex === 0">
          <img src="../../assets/img/login/kyqp/no_r.png" v-if="tabIndex === 0" @click="goRegister">
          <img src="../../assets/img/login/kyqp/active_r.png" v-if="tabIndex === 1">
        </div>
        <div class="cont-box">
          <div v-if="tabIndex === 0" class="form">
            <ul>
              <li class="user-name">
                <i>
                  <img src="../../assets/img/login/kyqp/user-icon.png" alt="">
                </i>
                <input
                  placeholder="请输入帐号"
                  ref="loginUserName"
              ...
              <li>
                <i>
                  <img src="../../assets/img/login/kyqp/pass-icon.png" alt="">
                </i>
                <input-row
                  v-model="password"
                  placeholder="请输入密码"
              ...
              >
                <i>
                  <img src="../../assets/img/login/kyqp/sms-icon.png" alt="">
                </i>
                <input-row
                  v-model="code"
                  placeholder="请输入验证码"
          ...
          <div v-if="tabIndex === 1" class="form register-form" ref="formHei">
            <ul>
              ...
              <li v-for="(item, i) in registerList" :key="'input-' + i">
                <i>
                  <img src="../../assets/img/login/kyqp/phone-icon.png" v-if="item.key == 'phone'">
                  <img src="../../assets/img/login/kyqp/sms-icon.png" v-else>
                </i>
                <input-row
        ...
        <div class="banner">
          <img src="../../assets/img/login/kyqp/banner1.png" alt="">
          <img src="../../assets/img/login/kyqp/banner2.png" alt="">
          <img src="../../assets/img/login/kyqp/banner3.png" alt="">
          <img src="../../assets/img/login/kyqp/banner4.png" v-if="['839qp','aqvns','dalao'].includes($config.name)">
        </div>
...
export default {
  ...
  created() {
    ...
    if(!['hty','dqr','839qp','103qp','fhcp','aqvns','dalao','xpj83'].includes(this.$config.name)) {
      this.goRegister()
    }
    this.checkArchCode();
