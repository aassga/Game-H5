<template>
  <view-page class="login-box" :full-box="!isShowFixed">
    <div slot="content">
      ...
      <drag-box @clickHandle="inService()" :h="1.47" :w="1" :x="6" :y="1.2" v-if="$config.name !== 'ylhg'">
        <div slot="content">
      ...
      <div class="down-shade" v-if="isShade">
        <div class="down-box">
          <div class="down-box-top" @click="onCloseShade"></div>
          <div class="down-box-bottom" @click="onDownload('enterprisesignLink')"></div>
          <div class="down-log">
            <img
...
.login-box {
  ...
  height: 5.6rem;
  position: relative;
  background: url("../../assets/img/login/bg-bet365.png") 0 0 no-repeat;
  background-size: 100%;
  .view-page-content {
