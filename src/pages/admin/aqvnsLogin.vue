  ...
  <view-page class="login-box">
    <div slot="content" class="top-content">
      <div class="vns-header self-vns-header">
        ...
        <div class="login-msg">
          <span>{{
            tabIndex === 0 ? "相信品牌力量 赢钱秒提现" : "澳门最大赌场 官方直营"
          }}</span>
        </div>
        <div class="title">
          <span
      ...
      <div class="content theme-main-bg-3">
        <div v-if="tabIndex === 0" class="form">
          <ul>
            ...
            <li
              ...
              class="theme-after-bg-color-num-input"
            >
              <input
                class="theme-color-white"
                v-model="code"
                ...
                autocomplete="new-password"
              />
              <img class="code-num" :src="$store.state.user.code.authImg" alt />
              <img
                class="refresh-code-num"
                src="../../assets/img/login/aqvns/admin-sign-icon.png"
                alt
        ...
        <div class="toolbar">
          <van-checkbox v-model="record"
            ><span class="remeber_pwd">保持登入</span></van-checkbox
          >
          <div v-if="tabIndex === 1" class="forget-pwd">
            <a
        ...
        <button
          ...
          @click="onSubmit"
          :class="
            tabIndex === 1 && modal.userName.length === 0
              ? 'theme-gray-bg'
              : 'theme-orange-bg'
          "
          class="submit theme-bg theme-color-white"
        >
          {{ tabIndex === 0 ? "登录" : "注册" }}
        </button>
        <div v-if="loginVerify == 'wyCode'" id="captchaVns"></div>
        <div class="remove-home" @click="goBack">随便逛逛</div>
      </div>
      ...
      <div class="down-shade" v-if="isShade">
        ...
        <div class="down-box-bottom">
          <img
            class="down-close"
            @click="onCloseShade"
            src="../../assets/img/login/aqvns/aqvns_close_btn.png"
            alt=""
          />
        </div>
      </div>
...
.login-box {
  ...
  height: 5.6rem;
  position: relative;
  background: url("../../assets/img/login/aqvns-admin-bg.png") 0 0 no-repeat;
...
.vns-header {
  ...
  .login-msg {
    ...
    font-size: 0.4rem;
    color: #ffffff;
    background: linear-gradient(180deg, rgb(225, 200, 176), rgb(191, 153, 118));
    -webkit-box-sizing: border-box;
    box-sizing: border-box;
    border-radius: 0.2rem 0.2rem 0 0;
    box-shadow: 0px 0.05rem 0.25rem 0px rgba(38, 91, 77, 0.5);
  }
  .title {
    box-sizing: border-box;
    display: flex;
    ...
    box-shadow: 0px -0.05rem 0.25rem 0px rgba(38, 91, 77, 0.3);
    ...
    .active {
      color: rgb(165, 135, 98) !important;
...
.content {
  ...
  .toolbar {
    ...
    margin: 0 0.27rem -0.6rem 0.27rem;
...
.theme-gray-bg {
  background-color: rgb(226, 233, 246) !important;
}
</style>
