  ...
  <view-page class="login-box" :full-box="!isShowFixed" ref="view-page">
    <div slot="content">
      <div class="content" v-show="!showStep">
        ...
        <div class="head">
          <img src="../../assets/img/login/blush/login-bg.png" v-if="tabIndex === 0" class="img-bg">
          <img src="../../assets/img/login/blush/reg-bg.png" v-if="tabIndex === 1" class="img-bg">
          <div class="down-btn down-btn1">
            <span @click="onDownload"
              ><img src="../../assets/img/login/blush/and_btn.png" alt=""
            /></span>
            <span @click="onDownload"
              ><img src="../../assets/img/login/blush/ios_btn.png" alt=""
            /></span>
          </div>
        </div>
        <div class="btn-group">
          <img src="../../assets/img/login/blush/no_l.png" v-if="tabIndex === 1" @click="goLogin">
          <img src="../../assets/img/login/blush/active_l.png" v-if="tabIndex === 0">
          <img src="../../assets/img/login/blush/no_r.png" v-if="tabIndex === 0" @click="goRegister">
          <img src="../../assets/img/login/blush/active_r.png" v-if="tabIndex === 1">
        </div>
        <div class="cont-box">
          <div v-if="tabIndex === 0" class="form">
            <ul>
              <li class="user-name">
                <i>
                  <img src="../../assets/img/login/blush/user-icon.png" alt="">
                </i>
                <input
                  placeholder="请输入帐号"
                  ref="loginUserName"
              ...
              <li>
                <i>
                  <img src="../../assets/img/login/blush/pass-icon.png" alt="">
                </i>
                <input-row
                  v-model="password"
                  placeholder="请输入密码"
              ...
              >
                <i>
                  <img src="../../assets/img/login/blush/sms-icon.png" alt="">
                </i>
                <input-row
                  v-model="code"
                  placeholder="请输入验证码"
          ...
          <div v-if="tabIndex === 1" class="form register-form" ref="formHei">
            <ul>
              ...
              <li v-for="(item, i) in registerList" :key="'input-' + i">
                <i>
                  <img src="../../assets/img/login/blush/phone-icon.png" v-if="item.key == 'phone'">
                  <img src="../../assets/img/login/blush/sms-icon.png" v-else>
                </i>
                <input-row
          ...
          <div v-if="tabIndex === 0" class="toolbar">
            ...
            <img src="../../assets/img/login/blush/open.png" v-if="record" @click="record = false">
            <img src="../../assets/img/login/blush/close.png" v-else @click="record = true">
          </div>
          <img src="../../assets/img/login/blush/login-btn.png" class="submit" @click="onSubmit" v-if="tabIndex === 0">
          <img src="../../assets/img/login/blush/reg-btn.png" class="submit" @click="onSubmit" v-if="tabIndex === 1">
          <div class="toggle">
            <p v-if="tabIndex === 0">
              没有帐号？<span @click="goRegister">立即注册</span>
            </p>
            <p v-if="tabIndex === 1">
              已有帐号？<span @click="goLogin">立即登录</span>
            </p>
          </div>
          <div v-if="loginVerify == 'wyCode'" id="captchaVnst"></div>
        </div>
        <div class="checkStep" @click="showStep = true">查看安装引导&gt;&gt;</div>
        <div class="banner">
          <img src="../../assets/img/login/blush/banner1.png" alt="">
          <img src="../../assets/img/login/blush/banner2.png" alt="">
          <img src="../../assets/img/login/blush/banner3.png" alt="">
          <img src="../../assets/img/login/blush/banner4.png" v-if="['839qp','aqvns'].includes($config.name)">
        </div>
        ...
        <div class="down-box">
          ...
          <img src="../../assets/img/login/blush/domain.png" class="domain">
          <div class="down-btn">
            <span @click="onDownload"
              ><img src="../../assets/img/login/blush/and_btn.png" alt=""
            /></span>
...
.login-box {
  background-color: #520107 !important;
  overflow: hidden;
}
.back-icon {
  position: absolute;
...
.content {
  ...
  .btn-group {
    ...
    // background: url(../../assets/img/login/blush/logBg.png) no-repeat;
  ...
  .cont-box {
    width: 95%;
    background: linear-gradient(0deg, #72010B, #95000D);
    border-radius: 10px;
    position: relative;
    margin: 0 auto;
    overflow: hidden;
