<template>
  <view-page class="login-box" :full-box="!isShowFixed">
    <div slot="content" class="container">
      <div class="down-log" v-show="showDownLog && tabIndex === 1 && $config.name === 'blr'">
          <div class="mask"></div>
          <div class="img-area">
            <img
      ...
      <img src="../../assets/img/login/blr-login/header-bg.png" class="header-bg">
      <div class="vns-header">
        <div class="title">
          <div :class="{active : tabIndex === 0}" @click="goLogin">
            <img v-if="tabIndex === 1" src="../../assets/img/login/blr-login/login.png" alt="">
            <img v-if="tabIndex === 0" src="../../assets/img/login/blr-login/login-active.png" alt="">
          </div>
          <div :class="{active : tabIndex === 1}" @click="goRegister">
            <img  v-if="tabIndex === 0" src="../../assets/img/login/blr-login/register.png" alt="">
            <img  v-if="tabIndex === 1" src="../../assets/img/login/blr-login/register-active.png" alt="">
          </div>
        </div>
      </div>
      <div class="content">
      ...
      <img src="../../assets/img/login/blr-login/bottom.png" class="bottom-img">
<!--       
      <drag-box @clickHandle="inService()" :h="1.52" :w="1" :x="6" :y="4" v-no-touch-move>
        <div slot="content">
          <img src="../../assets/img/login/blr-login/kefu.png" alt="" style="width:100%;height:100%">
        </div>
      </drag-box> -->
    </div>
...
.container {
  min-height: 13.62rem;
  width: 100%;
  background-image: url("../../assets/img/login/blr-login/bg.png");
...
.content {
  width: 7.02rem;
  background: linear-gradient(0deg, #DBF9FD, #FFFFFF);
  box-shadow: 0px 0.03rem 0.21rem 0px rgba(0, 0, 0, 0.24);
